...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "imaging@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "imaging API";

        private String description = "imaging API documentation";
