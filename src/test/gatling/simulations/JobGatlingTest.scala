...
class JobGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("imagingapp:mySecretOAuthSecret".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Job entity")
        ...
        .formParam("client_id", "imagingapp")
        ...
        .repeat(2) {
            ...
            .post("/api/jobs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "lastStart":"2020-01-01T00:00:00.000Z", "lastStop":"2020-01-01T00:00:00.000Z", "status":null}""")).asJSON
            .check(status.is(201))
